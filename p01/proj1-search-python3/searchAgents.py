...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        space)
        """
        state = (self.startingPosition[0], self.startingPosition[1], self.visitedCorners)
        return state
    ...
    def isGoalState(self, state):
        ...
        """
        (x, y, visitedCorners) = tuple(state)
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if ((nextx, nexty) in self.corners) and not ((nextx, nexty) in visitedCorners):
...
def cornersHeuristic(state, problem):
    ...
    cornerDistances = []
    for corner in list(set(corners) - set(visitedCorners)):
        dist = mazeDistance(loc, corner, problem.startGameState)
